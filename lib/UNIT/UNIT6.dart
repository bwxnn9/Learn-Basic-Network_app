import 'package:Basic_network_app/E-Books/Book_UNIT6.dart';
import 'package:Basic_network_app/Quiz/quiz_U6/screens/quiz_screen6.dart';
import 'package:Basic_network_app/configs/themes/app_colors.dart';
import 'package:flutter/material.dart';

class infounit6 extends StatelessWidget {
  const infounit6({super.key});
      ...
      child: Padding(
        ...
        child: ListView(
          children: [
            ...
            const SizedBox(height: 5),
            Text(
              "6.1 โทโพโลยี\n6.2 รูปแบบการเชื่อมต่อเครือข่าย\n6.3 การเชื่อมต่อเครือข่าย Lan\n6.4 การเชื่อมต่อระบบอินเทอร์เน็ต",
              style: TextStyle(
                fontSize: 16,
                fontWeight: FontWeight.w500,
                color: Colors.white.withOpacity(1),
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => book_6()));
                      },
                      child: Container(
                        padding:
